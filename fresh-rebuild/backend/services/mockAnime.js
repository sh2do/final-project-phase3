...
const MOCK_ANIME_DATABASE = [
  {
    ...
    aired: { from: "2019-04-06T00:00:00+00:00", to: "2019-09-28T00:00:00+00:00" },
    score: 8.73,
    synopsis: "Tanjiro's family is slaughtered by demons, and his sister Nezuko is turned into a demon. To undo this curse, Tanjiro sets out on a journey to find a cure.",
    genres: [
    ...
    images: {
      jpg: {
        ...
        large_image_url: "https://api.jikan.moe/v4/images/anime/38480_large.jpg"
      }
    }
  },
  {
    ...
    episodes: 25,
    status: "Finished Airing",
    aired: { from: "2013-04-07T00:00:00+00:00", to: "2013-09-28T00:00:00+00:00" },
    score: 8.51,
    synopsis: "In a world where giant humanoid Titans devour human flesh, the last remnants of humanity live behind enormous concrete walls.",
    genres: [
      { mal_id: 1, type: "anime", name: "Action" },
      { mal_id: 8, type: "anime", name: "Adventure" },
    ...
    images: {
      jpg: {
        ...
        large_image_url: "https://api.jikan.moe/v4/images/anime/16498_large.jpg"
      }
    }
  },
  {
    ...
    score: 7.92,
    synopsis: "Naruto Uzumaki, a hyperactive ninja-in-training, constantly searches for recognition from his peers in the village of Konoha.",
    genres: [
      { mal_id: 1, type: "anime", name: "Action" },
      { mal_id: 8, type: "anime", name: "Adventure" },
  ...
  },
  {
    ...
    score: 8.5,
    synopsis: "As a child, Monkey D. Luffy dreamed of becoming the greatest fisherman. But a misunderstanding led him to want to become the greatest pirate instead!",
    genres: [
      { mal_id: 1, type: "anime", name: "Action" },
      { mal_id: 8, type: "anime", name: "Adventure" },
  ...
  },
  {
    ...
    episodes: 24,
    status: "Finished Airing",
    aired: { from: "2020-10-03T00:00:00+00:00", to: "2021-03-27T00:00:00+00:00" },
    score: 8.47,
    synopsis: "A boy swallows a cursed finger and joins a secret organization of jujutsu sorcerers to find the rest of the body of a demon king.",
    genres: [
      { mal_id: 1, type: "anime", name: "Action" },
      { mal_id: 6, type: "anime", name: "Fantasy" },
    ...
    images: {
      jpg: {
        ...
        large_image_url: "https://api.jikan.moe/v4/images/anime/37989_large.jpg"
      }
    }
  },
  {
    ...
    episodes: 37,
    status: "Finished Airing",
    aired: { from: "2006-10-03T00:00:00+00:00", to: "2007-06-26T00:00:00+00:00" },
    score: 8.62,
    synopsis: "An intelligent high school student goes on a secret crusade to eliminate criminals using a supernatural power that allows him to kill anyone.",
    genres: [
  ...
  },
  {
    ...
    episodes: 24,
    status: "Finished Airing",
    aired: { from: "2011-04-09T00:00:00+00:00", to: "2011-09-14T00:00:00+00:00" },
    score: 8.73,
    synopsis: "Okabe Rintaro is a mad scientist who discovers a method to send messages to the past through a microwave oven.",
    genres: [
      { mal_id: 7, type: "anime", name: "Supernatural" },
      { mal_id: 6, type: "anime", name: "Fantasy" },
      { mal_id: 4, type: "anime", name: "Psychological" }
  ...
  },
  {
    ...
    score: 9.16,
    synopsis: "Two brothers use alchemy to try to resurrect their dead mother, but the transmutation goes wrong, and they become outcasts.",
    genres: [
      { mal_id: 1, type: "anime", name: "Action" },
      { mal_id: 8, type: "anime", name: "Adventure" },
      { mal_id: 6, type: "anime", name: "Fantasy" }
  ...
  },
  {
    ...
    episodes: 366,
    status: "Finished Airing",
    aired: { from: "2004-10-05T00:00:00+00:00", to: "2012-12-13T00:00:00+00:00" },
    score: 7.71,
    synopsis: "Ichigo Kurosaki is a teenager capable of seeing ghosts. He is surprised to meet Rukia, a Soul Reaper assigned to protect his town.",
    genres: [
      { mal_id: 1, type: "anime", name: "Action" },
      { mal_id: 8, type: "anime", name: "Adventure" },
      { mal_id: 7, type: "anime", name: "Supernatural" }
  ...
  },
  {
    ...
    episodes: 25,
    status: "Finished Airing",
    aired: { from: "2012-07-07T00:00:00+00:00", to: "2012-12-22T00:00:00+00:00" },
    score: 7.44,
    synopsis: "In the year 2022, gamers are thrilled by the announcement of an upcoming virtual reality MMORPG called Sword Art Online.",
    genres: [
      { mal_id: 1, type: "anime", name: "Action" },
      { mal_id: 8, type: "anime", name: "Adventure" },
      { mal_id: 6, type: "anime", name: "Fantasy" }
    ...
    images: {
      jpg: {
        ...
        large_image_url: "https://api.jikan.moe/v4/images/anime/28977_large.jpg"
      }
    }
  }
];
